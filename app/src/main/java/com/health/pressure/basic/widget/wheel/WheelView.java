package com.health.pressure.basic.widget.wheel;

import static com.health.pressure.basic.widget.wheel.WheelParams.dp2px;
...
public final class WheelView extends ViewGroup {
    ...
    //没有指定宽或高时的默认大小
    private static final int DEF_SIZE = dp2px(128);
    //WheelView相关参数
